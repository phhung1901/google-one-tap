...
class CloudDeploy extends \Google\Service
{
  ...
  public function __construct($clientOrConfig = [], $rootUrl = null)
  {
    ...
    $this->version = 'v1';
    $this->serviceName = 'clouddeploy';

    $this->projects_locations = new CloudDeploy\Resource\ProjectsLocations(
        $this,
        $this->serviceName,
        'locations',
        [
    ...
    $this->projects_locations_deliveryPipelines = new CloudDeploy\Resource\ProjectsLocationsDeliveryPipelines(
        $this,
        $this->serviceName,
        'deliveryPipelines',
        [
    ...
    $this->projects_locations_deliveryPipelines_releases = new CloudDeploy\Resource\ProjectsLocationsDeliveryPipelinesReleases(
        $this,
        $this->serviceName,
        'releases',
        [
    ...
    $this->projects_locations_deliveryPipelines_releases_rollouts = new CloudDeploy\Resource\ProjectsLocationsDeliveryPipelinesReleasesRollouts(
        $this,
        $this->serviceName,
        'rollouts',
        [
    ...
    $this->projects_locations_operations = new CloudDeploy\Resource\ProjectsLocationsOperations(
        $this,
        $this->serviceName,
        'operations',
        [
    ...
    $this->projects_locations_targets = new CloudDeploy\Resource\ProjectsLocationsTargets(
        $this,
        $this->serviceName,
        'targets',
        [
...
class_alias(CloudDeploy::class, 'Google_Service_CloudDeploy');
